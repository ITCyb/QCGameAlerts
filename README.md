QCGame Alerts - Custome plugin for Queercraft Minecraft server, to announce when a player joins a minigame. This plugin requires dependency of WorldGuard due to it using WorldGuard flags. To set up, go to the WorldGuard region
and define the flag 'qcga-game (Minigame name)'. 
